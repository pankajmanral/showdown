...
class Product(models.Model):
    ...
    def __str__(self):
        return f'{self.product_name} | {self.product_description} | {self.product_brand.brand_name} | {self.product_price} | {self.tag}'
                  # this thing is displayed in the admin pannel to the admin 
...
class FeaturedProduct(models.Model):
    ...
    def __str__(self):
        return f'{self.featured_product.product_name} | {self.featured_product.tag}'
                # this thing is displayed in the admin pannel to the admin 
